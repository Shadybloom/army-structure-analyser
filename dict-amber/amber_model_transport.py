#----
# Грузоперевозки (груз + тара):

metadict_detail['Доставка воды для хозяйства (нетто) (килограмм)'] = {
        'Доставка воды для хозяйства (брутто) (килограмм)':1,
        }

metadict_detail['Доставка воды для хозяйства (тара) (килограмм)'] = {
        'Доставка воды для хозяйства (брутто) (килограмм)':1,
        }

metadict_detail['Доставка грузов от ближайшего леса (нетто) (килограмм)'] = {
        'Доставка грузов от ближайшего леса (брутто) (килограмм)':1,
        }

metadict_detail['Доставка грузов от ближайшего леса (тара) (килограмм)'] = {
        'Доставка грузов от ближайшего леса (брутто) (килограмм)':1,
        }

metadict_detail['Доставка зернобобовых (нетто) (килограмм)'] = {
        'Доставка зернобобовых (брутто) (килограмм)':1,
        }

metadict_detail['Доставка зернобобовых (тара) (килограмм)'] = {
        'Доставка зернобобовых (брутто) (килограмм)':1,
        }

metadict_detail['Доставка зерновых (нетто) (килограмм)'] = {
        'Доставка зерновых (брутто) (килограмм)':1,
        }

metadict_detail['Доставка зерновых (тара) (килограмм)'] = {
        'Доставка зерновых (брутто) (килограмм)':1,
        }

metadict_detail['Доставка масличного сырья (нетто) (килограмм)'] = {
        'Доставка масличного сырья (брутто) (килограмм)':1,
        }

metadict_detail['Доставка масличного сырья (тара) (килограмм)'] = {
        'Доставка масличного сырья (брутто) (килограмм)':1,
        }

metadict_detail['Доставка овощей (нетто) (килограмм)'] = {
        'Доставка овощей (брутто) (килограмм)':1,
        }

metadict_detail['Доставка овощей (тара) (килограмм)'] = {
        'Доставка овощей (брутто) (килограмм)':1,
        }

metadict_detail['Доставка продовольствия (нетто) (килограмм)'] = {
        'Доставка продовольствия (брутто) (килограмм)':1,
        }

metadict_detail['Доставка продовольствия (тара) (килограмм)'] = {
        'Доставка продовольствия (брутто) (килограмм)':1,
        }

metadict_detail['Доставка сельскохозяйственного сырья (нетто) (килограмм)'] = {
        'Доставка сельскохозяйственного сырья (брутто) (килограмм)':1,
        }

metadict_detail['Доставка сельскохозяйственного сырья (тара) (килограмм)'] = {
        'Доставка сельскохозяйственного сырья (брутто) (килограмм)':1,
        }

metadict_detail['Доставка фруктов (нетто) (килограмм)'] = {
        'Доставка фруктов (брутто) (килограмм)':1,
        }

metadict_detail['Доставка фруктов (тара) (килограмм)'] = {
        'Доставка фруктов (брутто) (килограмм)':1,
        }

metadict_detail['Импорт продовольствия (нетто) (килограмм)'] = {
        'Импорт продовольствия (брутто) (килограмм)':1,
        }

metadict_detail['Импорт продовольствия (тара) (килограмм)'] = {
        'Импорт продовольствия (брутто) (килограмм)':1,
        }
...
metadict_detail['Доставка воды для промышленности (нетто) (килограмм)'] = {
        'Доставка воды для промышленности (брутто) (килограмм)':1,
        }

metadict_detail['Доставка воды для промышленности (тара) (килограмм)'] = {
        'Доставка воды для промышленности (брутто) (килограмм)':1,
        }

metadict_detail['Доставка промышленных товаров (нетто) (килограмм)'] = {
        'Доставка промышленных товаров (брутто) (килограмм)':1,
        }

metadict_detail['Доставка промышленных товаров (тара) (килограмм)'] = {
        'Доставка промышленных товаров (брутто) (килограмм)':1,
        }
...
metadict_detail['Импорт продовольствия (брутто) (килограмм)'] = {
...
metadict_detail['Железнодорожное направление Кантерлот-Филлидельфия (тонн)'] = {
        ...
        'Погрузочно-разгрузочные работы (тонн)':1 * 2,
        }
...
metadict_detail['Гужевые грузоперевозки воды (тонно-километр)'] = {
        'Путь пегаса с телегой (часов)':0.1,
        'Использование 100-литровой бочки для перевозки воды (часов)':0.1,
        '|===Грузооборот (тонно-километр)':1,
        }
