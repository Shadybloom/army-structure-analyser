...
metadict_model['Эквестрийские дороги (километр)'] = {
        ...
        'Эквестрийские мосты (25 метров)':1 / 10,
        }
...
#----
# Железные дороги Эквестрии

metadict_model['Эквестрийские железные дороги'] = {
        # Исправить
            # Перенести в "basis", это часть инфраструктуры страны.
        ...
        'Эквестрийские железные дороги (эксплуатация)':1,
        'Эквестрийские железные дороги (строительство)':1,
        }

#----
# Железные дороги (эксплуатация и ремонт путей):

metadict_model['Эквестрийские железные дороги (эксплуатация)'] = {
        'Эквестрийские железные дороги (километр)':2000 + 2500 + 1000 + 1000 + 500 + 1500,
        }
...
metadict_model['Эквестрийские железные дороги (километр)'] = {
        ...
        'Эквестрийские железнодорожные мосты (25 метров)':1 / 3,
        }
...
#----
# Железные дороги (строительство путей):

metadict_model['Эквестрийские железные дороги (строительство)'] = {
        'Эквестрийские железные дороги (проект)':1 / 30,
        }

metadict_model['Эквестрийские железные дороги (проект)'] = {
        # Исправить
            # Укажи пути, чтобы не запутаться.
            # А вообще, стоило бы плотность путей выводить из численности населения.
            # Или, ещё лучше, из требований к железнодорожному грузообороту (там ведь маршруты указаны).
        'Строительство главных путей (километр)':2000 + 2500 + 1000 + 1000 + 500 + 1500,
        'Строительство подъездных путей (километр)':(2000 + 2500 + 1000 + 1000 + 500 + 1500) * 0.2,
        'Строительство станционных путей (километр)':(2000 + 2500 + 1000 + 1000 + 500 + 1500) * 0.2,
        }
