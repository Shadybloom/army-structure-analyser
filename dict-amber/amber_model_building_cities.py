...
metadict_model['-Городское домохозяйство'] = {
        ...
        # В семье 5 пони, каждой по 15 метров жилья (без учёта кухонь/коридоров/кладовых)
        'Городское жильё (наличие) (квадратный метр)':15 * 5,
        }
...
metadict_model['-Сельское домохозяйство'] = {
        # Исправить
            # Не слишком ли просторные участки? Улицы получаются слишком длинными
            # Для защиты от пожаров рекомендую разрывы в 6 сажень (13 метров)
