...
metadict_detail['125-мм гладкоствольная танковая пушка'] = {
        # https://ru.wikipedia.org/wiki/2А46
        'Выстрелы 125-мм подкалиберные (в таре)':20,
        'Выстрелы 125-мм осколочно-фугасные (в таре)':20,
...
metadict_detail['Выстрелы 125-мм осколочно-фугасные (в таре)'] = {
        'Ящик 125-мм осколочно-фугасных снарядов (1 снаряд)':1,
        }

metadict_detail['Выстрелы 125-мм подкалиберные (в таре)'] = {
        'Ящик 125-мм подкалиберных снарядов (1 снаряд)':1,
        }
...
metadict_detail['Ящик осклочных гранат (20 штук)'] = {
        ...
        '-Допустимая масса тары боеприпасов (килограмм)':9,
        '-Допустимая стоимость тары боеприпасов ($)':5,
        }
...
metadict_detail['Ящик 80-мм миномётных мин (8 мин)'] = {
        ...
        '-Объём используемый (кубометров)':1 * 0.45 * 0.25,
        '-Допустимая масса тары боеприпасов (килограмм)':9,
        '-Допустимая стоимость тары боеприпасов ($)':10,
        }

metadict_detail['Ящик 120-мм миномётных мин (2 мины)'] = {
        'Миномётные мины 120-мм':2,
        '-Объём используемый (кубометров)':1 * 0.45 * 0.25,
        '-Допустимая масса тары боеприпасов (килограмм)':22,
        '-Допустимая стоимость тары боеприпасов ($)':10,
        }
...
metadict_detail['Ящик 125-мм осколочно-фугасных снарядов (1 снаряд)'] = {
        'Выстрелы 125-мм осколочно-фугасные':1,
        '-Объём используемый (кубометров)':1 * 0.45 * 0.25,
        '-Допустимая масса тары боеприпасов (килограмм)':22,
        '-Допустимая стоимость тары боеприпасов ($)':10,
        }

metadict_detail['Ящик 125-мм подкалиберных снарядов (1 снаряд)'] = {
        'Выстрелы 125-мм подкалиберные':1,
        '-Объём используемый (кубометров)':1 * 0.45 * 0.25,
        '-Допустимая масса тары боеприпасов (килограмм)':22,
        '-Допустимая стоимость тары боеприпасов ($)':10,
        }
...
metadict_detail['Ящик 120-мм реактивных снарядов (1 снаряд)'] = {
        ...
        '-Допустимая масса тары боеприпасов (килограмм)':26,
        '-Допустимая стоимость тары боеприпасов ($)':10,
        }
...
metadict_detail['Контейнер 220-мм реактивных снарядов (4 снаряда)'] = {
        ...
        'Реактивные снаряды 220-мм':4,
        '-Объём используемый (кубометров)':5.37 * 0.7116 * 0.728,
        '-Допустимая масса тары боеприпасов (килограмм)':320,
        '-Допустимая стоимость тары боеприпасов ($)':1000,
        }

#----
# Танковые выстрелы:

metadict_detail['Выстрелы 125-мм осколочно-фугасные'] = {
        # http://www.russianarms.ru/forum/index.php/topic,9614.0.html
        'Снаряды 125-мм осколочно-фугасные':1,
        'Метательный заряд калибра 125-мм':1,
        'Гильза сгораемая калибра 125-мм':1,
        }

metadict_detail['Выстрелы 125-мм подкалиберные'] = {
        # Исправить
            # Основной и дополнительный метательные заряды.
        # http://www.russianarms.ru/forum/index.php/topic,9634.0.html
        'Снаряды 125-мм подкалиберные':1,
        'Метательный заряд калибра 125-мм':2,
        'Гильза сгораемая калибра 125-мм':1,
        }
...
metadict_detail['Магазин на 50 патронов 6x48'] = {
        'Патроны 6x48':50,
        '-Допустимая масса тары боеприпасов (тонн)':0.0003,
        '-Допустимая стоимость тары боеприпасов ($)':10,
        }
...
metadict_detail['Лента на 50 патронов 12x96'] = {
        'Патроны 12x96':50,
        '-Допустимая масса тары боеприпасов (тонн)':0.0012,
        '-Допустимая стоимость тары боеприпасов ($)':5,
        }

metadict_detail['Лента на 50 патронов 15x120'] = {
        'Патроны 15x120':50,
        '-Допустимая масса тары боеприпасов (тонн)':0.0015,
        '-Допустимая стоимость тары боеприпасов ($)':5,
        }

metadict_detail['Лента на 50 снарядов 24x120 бронебойно-зажигательных'] = {
        'Выстрелы 24x120 бронебойно-зажигательные':50,
        '-Допустимая масса тары боеприпасов (тонн)':0.003,
        '-Допустимая стоимость тары боеприпасов ($)':5,
        }
...
metadict_detail['Лента на 50 патронов 6x48'] = {
        'Патроны 6x48':50,
        '-Допустимая масса тары боеприпасов (тонн)':0.0001,
        '-Допустимая стоимость тары боеприпасов ($)':1,
        }
...
metadict_detail['Снаряды 125-мм подкалиберные'] = {
        # Исправить
            # Уточнить стоимость.
        ...
        # Масса ВУ (ведущего устройства) -- 2 кг
        # http://www.russianarms.ru/forum/index.php/topic,9634.0.html
        # http://fofanov.armor.kiev.ua/Tanks/ARM/apfsds/ammo_r.html
        # http://btvt.narod.ru/4/t-62/v2.jpg
        # http://btvt.narod.ru/4/t-62/v1.jpg
        'Нержавеющая сталь (килограмм)':3.5 + 2,
        'Урановый сплав БПС (килограмм)':0.3,
        '-Вероятность поражения цели снарядом (танк)':0.5 * 0.5,
        '-Допустимая масса боеприпасов (килограмм)':3.8 + 2,
        '-Допустимая стоимость боеприпасов ($)':5000,
        }

metadict_detail['Снаряды 125-мм осколочно-фугасные'] = {
        # Исправить
            # Дублирует ОФС калибра 120-мм.
        # http://www.russianarms.ru/forum/index.php/topic,11950.0.html
        'Нержавеющая сталь (килограмм)':17.8,
        'Гексал (килограмм)':3.97,
        '-Расчётный боеприпас (РБ)':0.7,
...
metadict_detail['Гильза сгораемая калибра 125-мм'] = {
        # Исправить
            # Узнать массу поддона и сгораемого корпуса.
        # Гильза со сгораемым корпусом и отбрасываемый поддон.
        # http://www.russianarms.ru/forum/index.php/topic,10759.0.html
        'Нержавеющая сталь (килограмм)':2,
        '-Допустимая масса боеприпасов (килограмм)':5,
        '-Допустимая стоимость боеприпасов ($)':200,
        }
...
metadict_detail['Метательный заряд калибра 125-мм'] = {
        # Пороховой заряд 4Ж52, гильза отдельно.
        # http://www.russianarms.ru/forum/index.php/topic,10759.0.html
        'Пироксилиновый порох (килограмм)':5,
        '-Допустимая масса боеприпасов (килограмм)':5,
        }
...
metadict_detail['Нитроглицериновый порох (килограмм)'] = {
        # Исправить
            # Уточнить долю нитроглицирина
        'Нитроглицерин (килограмм)':0.25,
        'Пироксилин (килограмм)':(0.7 + 0.8) / 2,
        '-Тротиловый эквивалент (килограмм)':1.54,
        }
