...
metadict_model['Торсион ОБТ'] = {
        # http://armor.kiev.ua/wiki/index.php?title=Торсион
...
metadict_model['Электронные компоненты (килограмм)'] = {
        '-Допустимая стоимость компонентов':1000,
        }

metadict_model['Электронно-лучевые приборы (килограмм)'] = {
        '-Допустимая стоимость компонентов':500,
        }
...
metadict_model['Броневая сталь листовая (килограмм)'] = {
        '-Допустимая стоимость компонентов':10,
        }
...
metadict_model['Броневое углеволокно (килограмм)'] = {
        '-Допустимая стоимость компонентов':50,
        '-Допустимая масса компонентов (килограмм)':1,
        }

metadict_model['Конструкционный углепластик (кубометров)'] = {
        # http://viam-works.ru/en/articles?art_id=886
        # Предел прочности ~2 ГПа
        'Конструкционный углепластик (килограмм)':1800,
        }

metadict_model['Конструкционный углепластик (килограмм)'] = {
        # http://viam-works.ru/en/articles?art_id=886
        # Предел прочности ~2 ГПа
        '-Допустимая стоимость компонентов':5,
        '-Допустимая масса компонентов (килограмм)':1,
        }

metadict_model['Бекелитовая фанера (кубометров)'] = {
        # Cопротивление растяжению 27 кг/мм² (у сосны 11 кг/мм², у дюралюминия 43 кг/мм²)
        'Бекелитовая фанера (килограмм)':1200,
        }

metadict_model['Бекелитовая фанера (килограмм)'] = {
        '-Допустимая стоимость компонентов':2,
        '-Допустимая масса компонентов (килограмм)':1,
        }

metadict_model['Синтетический брезент (квадратные метры)'] = {
        # Армированный и ламинированный синтетический брезент.
        # Либо пропитанная смесью воска и льняного масла ткань.
        'Синтетический брезент (килограмм)':0.5,
        }

metadict_model['Синтетический брезент (килограмм)'] = {
        '-Допустимая стоимость компонентов':2,
        '-Допустимая масса компонентов (килограмм)':1,
        }
...
metadict_model['Броневое стекловолокно (килограмм)'] = {
        '-Допустимая стоимость компонентов':25,
        }
...
metadict_model['Броневой алюминий (килограмм)'] = {
        '-Допустимая стоимость компонентов':16,
        }
...
metadict_model['Угольник вентилятора ОБТ'] = {
        'Танковые литые детали (килограмм)':46,
        }

metadict_model['Кронштейн на корпусе ОБТ'] = {
        # Сталь специальная
        'Танковые литые детали (килограмм)':10,
        }

metadict_model['Кронштейн редуктора ОБТ'] = {
        'Танковые литые детали (килограмм)':6,
        }

metadict_model['Кронштейн привода вентилятора ОБТ'] = {
        'Танковые литые детали (килограмм)':16,
        }

metadict_model['Перегородка вентиляторная ОБТ'] = {
        'Танковые литые детали (килограмм)':17,
        }

metadict_model['Крышка технического люка ОБТ'] = {
        'Танковые литые детали (килограмм)':8,
        }

metadict_model['Крюк буксировочный передний ОБТ'] = {
        'Танковые литые детали (килограмм)':15,
        }

metadict_model['Крюк буксировочный задний ОБТ'] = {
        'Танковые литые детали (килограмм)':15,
        }

metadict_model['Кронштейн балансира ОБТ'] = {
        'Танковые литые детали (килограмм)':35,
        }

metadict_model['Упор балансира ОБТ'] = {
        # Сталь марки 38ХС
        # http://metallicheckiy-portal.ru/marki_metallov/stk/38XS
        'Танковые литые детали (килограмм)':5,
        }

metadict_model['Кронштейн ленивца ОБТ'] = {
        'Танковые литые детали (килограмм)':55,
        }

metadict_model['Кронштейн амортизатора ОБТ'] = {
        'Танковые литые детали (килограмм)':20,
        }

#----
# Детали моторно-трансмиссионного отделения ОБТ:

metadict_model['Крыша над мотором ОБТ'] = {
        # Кстати, вот тебе и кормовая броневая деталь
        'Танковые литые детали (килограмм)':246,
        }

metadict_model['Крыша над радиаторами ОБТ'] = {
        'Танковые литые детали (килограмм)':230,
        }

metadict_detail['Привод жалюзи МТО ОБТ'] = {
        'Танковые электромеханические устройства (килограмм)':14,
        }

metadict_model['Жалюзи выходные МТО ОБТ'] = {
        'Танковые литые детали (килограмм)':141,
        }

metadict_model['Подъёмное устройство крыши МТО ОБТ'] = {
        'Танковые электромеханические устройства (килограмм)':11.8,
        }

metadict_model['Балка крыши МТО ОБТ'] = {
        'Танковые литые детали (килограмм)':50,
        }

metadict_model['Торсион крыши МТО ОБТ'] = {
        'Танковые механические устройства (килограмм)':6,
        }

#----
# Люки ОБТ:

metadict_model['Передний люк корпуса ОБТ'] = {
        'Танковые литые детали (килограмм)':73,
        }

metadict_model['Аварийный люк корпуса ОБТ'] = {
        'Танковые литые детали (килограмм)':32,
        }

metadict_model['Технические лючки корпуса ОБТ'] = {
        'Танковые литые детали (килограмм)':16,
        }

metadict_model['Технические люки корпуса ОБТ'] = {
        'Танковые литые детали (килограмм)':24,
        }
